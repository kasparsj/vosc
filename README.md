...
Examples:
```supercollider
~visuals.sendMsg('/tex/var', 0, "const"); // set first layer data source to constant 1
~visuals.sendMsg('/tex/var', 0, "const:23"); // set first layer data source to constant 23
~visuals.sendMsg('/tex/var', 0, "rand"); // set first layer data source to random
~visuals.sendMsg('/tex/var', 0, "rand:100"); // set first layer data source to random of 100
~visuals.sendMsg('/tex/var', 0, "noise"); // set first layer data source to perlin noise
~visuals.sendMsg('/tex/var', 0, "noise:50"); // set first layer data source to perlin noise of 50
~visuals.sendMsg('/tex/var', 0, "loud:0"); // set first layer data source to channel 1 loudness
~visuals.sendMsg('/tex/var', 0, "amp:1"); // set first layer data source to channel 2 amplitude
```
