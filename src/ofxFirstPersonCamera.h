...
class ofxFirstPersonCamera : public ofCamera
{
    public:
        ...
        void updateRotationMouse( bool _constrainToYAxis = false )
        {
            ...
            ofQuaternion tmpRotX( rotationSpeed.x, glm::vec3(1,0,0));
            ofQuaternion tmpRotY( rotationSpeed.y, glm::vec3(0,1,0));
            
            // Todo: neater solution to this
            if( _constrainToYAxis ) { setOrientation( getOrientationQuat() * glm::quat(tmpRotY) ); }
            else { setOrientation( tmpRotX * getOrientationQuat() * glm::quat(tmpRotY) ); }
        }
        ...
        void updateRotationJoystick( bool _constrainToYAxis = false )
        {
            ...
            ofQuaternion tmpRotX( rotationJoystickSpeed.x, glm::vec3(1,0,0));
            ofQuaternion tmpRotY( rotationJoystickSpeed.y, glm::vec3(0,1,0));
        ...
        // ----------------------------------------------
        void setForwardKey(  char _forwardKey ) { forwardKey     = _forwardKey; }
        void setBackwardKey( char _backwardKey) { backwardKey     = _backwardKey; }
        void setRightKey(      char _rightKey)     { rightKey         = _rightKey; }
        void setLeftKey(      char _leftKey)     { leftKey         = _leftKey; }
